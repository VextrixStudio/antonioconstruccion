...
import { ArrowUpRight, HardHat, Building2, PaintBucket, Hammer, Ruler, Briefcase, Phone, CheckCircle2, Wrench, Layers, Home as HomeIcon, Store, QrCode } from "lucide-react";
            ...
            <div className="lg:col-span-8 space-y-8">
              ...
              <div className="flex flex-wrap items-center gap-5 pt-4">
                ...
                <div className="flex items-center gap-4 pl-2">
                  <a
                    href="https://www.instagram.com/antonioenriquezconstruction/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-4 border border-white/20 bg-white/10 text-zinc-200 hover:text-amber-400 hover:border-amber-500/50 transition-all rounded-none"
                  ...
                  <a
                    href="https://www.youtube.com/@antonioenriquezconstructionon"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-4 border border-white/20 bg-white/10 text-zinc-200 hover:text-amber-400 hover:border-amber-500/50 transition-all rounded-none"
                    aria-label="YouTube"
                  ...
                  <a
                    href="https://antonioenriquezconstruction.com/qr"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-4 border border-white/20 bg-white/10 text-zinc-200 hover:text-amber-400 hover:border-amber-500/50 transition-all rounded-none"
                    aria-label="QR Code"
